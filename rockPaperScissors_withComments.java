...
public class rockPaperScissors {
    // Declare public variable in the scope of the class
    String playerName;
    String playerMove;
    String computerMove;
    //score used to keep track of the rounds
    int score;
    ...
    private void playGame(){
        ...
        //Method to generate the computer move
        computerMove = generateComputerMove();
        //Feed the moves into the getWinner method and store the reference as a variable
